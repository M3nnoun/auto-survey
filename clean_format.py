...
column_mapping = {
    ...
    'للإضاءة (ما هي أنواع مصادر الطاقة التي تستخدمها بشكل أساسي لتلبية احتياجات الطاقة المنزلية؟ (1))': 'MEclairage',
    'للطهي (ما هي أنواع مصادر الطاقة التي تستخدمها بشكل أساسي لتلبية احتياجات الطاقة المنزلية؟ (1))': 'MCuisine',
    'للتبريد/للتسخين (ما هي أنواع مصادر الطاقة التي تستخدمها بشكل أساسي لتلبية احتياجات الطاقة المنزلية؟ (1))': 'MRefroidissementChauffage',
    'للتدفئة (ما هي أنواع مصادر الطاقة التي تستخدمها بشكل أساسي لتلبية احتياجات الطاقة المنزلية؟ (1))': 'MChauffage',
    'هل تواجه أي صعوبات في التنقل أو الحركة؟ (هل واجهت أي صعوبات في حياتك اليومية بسبب ظروف صحية أو جسدية؟)': 'DifficultesDeplacement',
    'هل تستخدم أي أدوات مساعدة أو أجهزة خاصة لمساعدتك في حياتك اليومية؟ (هل واجهت أي صعوبات في حياتك اليومية بسبب ظروف صحية أو جسدية؟)': 'techniquesAider',
    'هل تواجه أي صعوبات في التواصل أو السمع أو البصر؟ (هل واجهت أي صعوبات في حياتك اليومية بسبب ظروف صحية أو جسدية؟)': 'DifficultesVision',
}
...
translations = {
    ...
    "Age": {20.0: 20, 15.0: 15, 32.0: 32, 22.0: 22, 33.0: 33, 30.0: 30, 38.0: 38, 21.0: 21, 24.0: 24, 18.0: 18,
            ...
            45.0: 45, 28.0: 28, 31.0: 31, 16.0: 16, 200.0: 20, },
...
hd.to_excel(excel_file_path, index=False)
